...
class TradeEntityConsumerIntegrationTest {
    ...
    void shouldConsumeAndPersistTradesFreshTrade() throws Exception {
        ...
        await()
                ...
                .untilAsserted(() ->
                        assertThat(tradeSQLRepo.findAll().size()).isEqualTo(2)
                );

        assertThat(tradeSQLRepo.findAll()).hasSize(2);
    }
    ...
    void shouldCreateANewVersionAndUpdateOtherTrade() throws Exception {
        ...
        await()
                .atMost(30, TimeUnit.SECONDS)
                .untilAsserted(() ->
                        assertThat(tradeSQLRepo.findAll().size()).isEqualTo(3)
                );

        assertThat(tradeSQLRepo.findAll()).hasSize(3);
    }
    ...
    void shouldRejectSomeTradesInBatch() throws Exception {
        ...
        await()
                .atMost(30, TimeUnit.SECONDS)
                .untilAsserted(() ->
                        assertThat(tradeSQLRepo.findAll().size()).isGreaterThanOrEqualTo(4)
                );
    }
